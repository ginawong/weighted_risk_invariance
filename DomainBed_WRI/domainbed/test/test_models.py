...
class TestAlgorithms(unittest.TestCase):
    ...
    @parameterized.expand(itertools.product(helpers.DEBUG_DATASETS, algorithms.ALGORITHMS, (True, False)))
    def test_init_update_predict(self, dataset_name, algorithm_name, pretrained_featurizer):
        """Test that a given algorithm inits, updates and predicts without raising
        errors."""
        batch_size = 8
        hparams = hparams_registry.default_hparams(algorithm_name, pretrained_featurizer, dataset_name)
